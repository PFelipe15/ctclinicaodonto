...
export default function Map() {
  ...
  const [center, setCenter] = useState({
    lat: -5.090878864707197,
    lng: -42.83387177656162
  });
  ...
  const handlePhoneMouseOver = () => {
    window.open('https://api.whatsapp.com/send?phone=5586988034600&text=Ol%C3%A1,%20quero%20uma%20consulta');
  };
        ...
        <div className="flex flex-col mt-4 justify-center gap-2 md:mr-8 font-bold text-primary">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center">
              ...
              <p>Av. Pres. Médici, 277</p>           
            </div>
            <div className="flex items-center">
              <MapPin size="32" className="text-primary" />
              <p>Parque Piaui 2, Timon.</p>
            </div>
            <div className="flex items-center">
              <MapPin size="32" className="text-primary" />
              <p>CEP: 65631-390</p>
