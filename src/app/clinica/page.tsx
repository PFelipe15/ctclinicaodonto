...
import Image1 from '../assets/clinicaImage.jpg';
import Image2 from '../assets/clinicaImage2.jpg';
...
const Clinica = () => {
  ...
  const imagens: StaticImageData[] = [Image1, Image1, Image1];
      ...
      <div className="grid grid-cols-1 animate-fadeIn sm:grid-cols-2 gap-6">
        <div className="bg-primary text-white p-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:bg-primary-dark hover:scale-105">
          ...
          <p className="text-white">
            Proporcionar atendimento de excelência em saúde bucal, focado em
            diagnóstico preciso e tratamentos inovadores para diversas patologias
            odontológicas, adotando uma abordagem personalizada e atenciosa,
            direcionada ao bem-estar dos pacientes.
          </p>
        </div>
        ...
        <div className="bg-primary text-white p-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:bg-primary-dark hover:scale-105">
          ...
          <p className="text-white">
            Tornar-se o centro de referência em odontologia na região, reconhecido
            por sua liderança em tratamentos de alta complexidade e pela
            constante inovação em práticas odontológicas, valorizando sempre a
      ...
      <div className="bg-primary text-white p-4 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:bg-primary-dark hover:scale-105 mt-6">
        ...
        <ul className="list-disc text-white pl-6 space-y-4">
          ...
          <li>
            ...
            a excelência clínica e a adaptação às novidades do campo odontológico.
          </li>
        </ul>
      </div>
